...
test.describe("Search", () => {
  test("if there's an article with a title that contains the search string, it appears on the results", async ({ page }) => {
    ...
    const articleTwo = page.getByRole("link", { name: /completely different/i });
